...
| Frontend       | [StreamWatch](https://StreamWatch.lol), [2](https://flix.kanded.xyz) | [source code](https://github.com/steveyout/smov)        |
...
- [StreamWatch Discord](https://discord.com/invite/nywCWBRz)
...
```bash
git clone https://github.com/steveyout/smov.git
cd smov
git pull
pnpm install
pnpm run dev
...
```bash
git remote add upstream https://github.com/steveyout/smov.git
