...
|----------------|------------------------------------------------------------------|----------------------------------------------------------|
| StreamWatch Docs | [sudo-docs](https://docs.undi.rest)                          | [source code](https://github.com/sussy-code/docs)        |
...
| Frontend       | [StreamWatch](https://docs.undi.rest/instances)                | [source code](https://github.com/sussy-code/smov)        |
